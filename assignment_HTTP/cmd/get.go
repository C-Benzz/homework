...
// NOTE: AutoGenerated is not a good name for struct. Maybe name it to be something more meaningful.
...
var getCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		// NOTE: What if I want to receive both query parameters and headers at the same time?
		if flagsQuery != "" {
